...
GLchar* Shader::loadshader( std::string filename )
{
    std::ifstream file;
...
void Shader::unloadshader( GLchar** ShaderSource )
{
    if (*ShaderSource != 0)
        delete[] * ShaderSource;
    *ShaderSource = 0;
...
GLuint Shader::compile_shaders( const char* vertexFilename, const char* fragmentFilename, const char* geometryFilename )
{
    GLuint vertex_shader;
    GLuint fragment_shader;
